...
def check_for_new_files(queue, status_manager, config, last_checked=None, should_continue=lambda: True):
    ...
    while should_continue():
        ...
        logging.info(f"更新最后一次检查时间")

        time.sleep(interval * 60)
        # logging.info(f"下次检查将在{interval}分钟后")
